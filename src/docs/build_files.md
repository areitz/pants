...
may encounter this exception:
    ...
    Exception message: Invalid target :what_changed: The `pants()` wrapper is obsolete and has been removed. See http://pantsbuild.github.io/build_files.html#what-happened-to-the-pants-wrapper-around-targets for more information.
     while executing BUILD file FilesystemBuildFile(/Users/andyr/workspace/pants/src/python/pants/backend/core/tasks/BUILD)
     Loading addresses from 'src/python/pants/backend/core/tasks' failed.

or the BUILD may fail with an error.
